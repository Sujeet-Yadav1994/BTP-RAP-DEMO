...
@EndUserText.label: 'Data Definition ZCOURSE_DEMO_04'
define root view entity ZI_COURSE_DEMO_04_N as select from ZCOURSE_DEMO_04  as Course
composition [0..*] of ZI_SCHEDULE_DEMO_04 as _Schedule
